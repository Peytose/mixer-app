...
struct QRCodeAnimationView: View {
    ...
    var qrView: some View {
        ...
        .overlay(
            BoxView(cornerRadius: 4, color: Color.mixerBackground, frame: CGSize(width:100, height: 220))
        )
        .overlay(
            BoxView(cornerRadius: 4, color: Color.mixerBackground, frame: CGSize(width:220, height: 100))
        )
        .overlay(
            Image("qrcode")
                .resizable()
        ...
        .overlay(
            BoxView(cornerRadius: 2, color: Color.mixerIndigo, frame: CGSize(width: 220, height: 2))
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 38)
                .stroke(Color.iPhoneStrokeGradient)
        )
        .overlay(
            CustomRoundedConrnerView(color: Color.mixerSecondaryBackground, tl: 0, tr: 0, bl: 14, br: 14)
