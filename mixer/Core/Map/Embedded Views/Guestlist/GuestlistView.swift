...
//                            .imageScale(.small)
//                            .foregroundColor(status == GuestStatus.invited ? Color.secondary : Color.theme.mixerIndigo)
//                            .fontWeight(.semibold)
//                    }
//                }
//
...
//                .minimumScaleFactor(0.7)
//        }
//        .listRowBackground(Color.theme.secondaryBackgroundColor.opacity(0.7))
...
//            .environmentObject(GuestlistViewModel(hostEventsDict: [Host(from: Mockdata.host): [Event(from: Mockdata.event)]]))
//    }
//}
