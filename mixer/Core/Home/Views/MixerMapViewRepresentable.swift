...
extension MixerMapViewRepresentable {
    class MapCoordinator: NSObject, MKMapViewDelegate {
        ...
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            if let annotation = annotation as? MixerLocationAnnotation {
        ...
        func addAnnotationsToMap(_ locations: [MixerLocation]) {
            let annotations = locations.map({ MixerLocationAnnotation(location: $0.self) })
