...
//                            
//                            Image(systemName: viewModel.isInviteOnly ? "envelope" : "envelope.fill")
//                        }
//                        
...
//                            EventDetailRow(title: "Public Address", value: viewModel.altAddress, alignment: .top)
//                        }
//                        
//
...
//            EventFlowActionButton(text: "Continue",
//                                  action: action,
//                                  isActive: true)
//        }
...
//        ReviewCreatedEventView(viewModel: EventCreationViewModel(), namespace: namespace) {}
