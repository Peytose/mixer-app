...
//    let gradient1 = Gradient(colors: [Color.theme.mixerIndigo, .red])
//    let gradient2 = Gradient(colors: [.blue, Color.theme.mixerPurple])
...
//        )
//        .overlay(
//            BoxView(cornerRadius: 4, color: Color.theme.backgroundColor, frame: CGSize(width: 200, height: DeviceTypes.ScreenSize.width * 0.85))
//        )
//        .overlay(
//            BoxView(cornerRadius: 4, color: Color.theme.backgroundColor, frame: CGSize(width: DeviceTypes.ScreenSize.width * 0.85, height: 200))
//        )
//        .overlay(
//            Image("qrcode")
//                .resizable()
